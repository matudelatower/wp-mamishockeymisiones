...
function mamihockyemisiones_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		...
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'mamihockyemisiones' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'mamihockyemisiones' );
}
...
function mamihockyemisiones_get_color_schemes() {
	 ...
	 * }
	 */
	return apply_filters( 'mamihockyemisiones_color_schemes', array(
		'default' => array(
...
function mamihockyemisiones_customize_preview_js() {
	wp_enqueue_script( 'mamihockyemisiones-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
...
//	Secciones
	...
	$wp_customize->add_control(
		'seccion_header_boton_texto',
		array(
			'label'   => __( 'Texto Botón', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_header',
			'type'    => 'text',
		)
	);
	...
	$wp_customize->add_control(
		'seccion_header_boton_url',
		array(
			'label'   => __( 'URL Botón', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_header',
			'type'    => 'text',
		)
	);
	...
	//	seccion acerca de
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_acercade',
		array(
			'title'         => __( 'Acerca de', 'mamihockyemisiones' ),
			'priority'      => 620,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		'seccion_acercade_activo',
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_acercade',
			'type'    => 'checkbox',
		)
	);
	...
	//	seccion que hacemos
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_que_hacemos',
		array(
			'title'         => __( 'Qué hacemos?', 'mamihockyemisiones' ),
			'priority'      => 630,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		...
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_que_hacemos',
			'type'    => 'checkbox',
		)
	);
...
//	seccion servicios
	...
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_servicios',
		array(
			'title'         => __( 'Servicios', 'mamihockyemisiones' ),
			'priority'      => 640,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		...
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_servicios',
			'type'    => 'checkbox',
		)
	);
	...
	$wp_customize->add_control(
		'seccion_servicios_titulo_seccion',
		array(
			'label'   => __( 'Título Sección', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_servicios',
			'type'    => 'text',
		)
	);
	...
	for ( $i = 1; $i <= 3; $i ++ ) {
		...
		$wp_customize->add_control(
			"seccion_servicios_widget_icono_$i",
			array(
				'label'   => __( 'Icono', 'mamihockyemisiones' ),
				'section' => 'mamihockyemisiones_seccion_servicios',
				'type'    => 'text',
			)
		);
	...
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_links_no_destacados',
		array(
			'title'         => __( 'Links no destacados', 'mamihockyemisiones' ),
			'priority'      => 650,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		...
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_links_no_destacados',
			'type'    => 'checkbox',
		)
	);
...
//		);
	...
	$wp_customize->add_control(
		'seccion_links_no_destacados_categoria',
		array(
			'label'   => __( 'Categoría', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_links_no_destacados',
			'type'    => 'select',
            'choices'=> $aCategorias
		)
...
//		'section'       => 'mamihockyemisiones_seccion_links_no_destacados',
//		'label'         => esc_html__( 'Categoría', 'mamihockyemisiones' ),
//		'description'   => esc_html__( 'Elegi una categoría para que sea mostrada en esta sección.', 'mamihockyemisiones' ),
...
//	) ) );
	...
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_links_no_destacados_con_descripcion',
		array(
			'title'         => __( 'Links no destacados con descripción', 'mamihockyemisiones' ),
			'priority'      => 660,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		...
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_links_no_destacados_con_descripcion',
			'type'    => 'checkbox',
		)
	);
	...
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_links_destacados_con_icono_descripcion',
		array(
			'title'         => __( 'Links destacados con icono y descripción', 'mamihockyemisiones' ),
			'priority'      => 670,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		...
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_links_destacados_con_icono_descripcion',
			'type'    => 'checkbox',
		)
	);
...
//	);
	...
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_links_destacados_con_fotos',
		array(
			'title'         => __( 'Links destacados con fotos', 'mamihockyemisiones' ),
			'priority'      => 680,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		...
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_links_destacados_con_fotos',
			'type'    => 'checkbox',
		)
	);
...
//	);
	...
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_noticias',
		array(
			'title'         => __( 'Noticias Destacadas', 'mamihockyemisiones' ),
			'priority'      => 690,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	$wp_customize->add_control(
		...
		array(
			'label'   => __( 'Activo', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_noticias',
			'type'    => 'checkbox',
		)
	);
...
//	$wp_customize->add_section(
//		'mamihockyemisiones_seccion_clientesdicen',
//		array(
//			'title'         => __( 'Los clientes dicen', 'mamihockyemisiones' ),
//			'priority'      => 650,
//			'capability'    => 'edit_theme_options',
//			'theme_support' => '',
//			'panel'         => 'mamihockyemisiones_secciones_panel'
...
//		array(
//			'label'   => __( 'Activo', 'mamihockyemisiones' ),
//			'section' => 'mamihockyemisiones_seccion_clientesdicen',
//			'type'    => 'checkbox',
//		)
//	);
//
...
//	);
	...
	$wp_customize->add_control(
		'seccion_contacto_titulo_formulario',
		array(
			'label'   => __( 'Título Formulario', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_seccion_contacto',
			'type'    => 'text',
		)
	);
...
//	Contacto / Social
	$wp_customize->add_panel( 'mamihockyemisiones_contact_social_panel',
		array(
			'priority'   => 710,
			'capability' => 'edit_theme_options',
	...
	$wp_customize->add_section(
		'mamihockyemisiones_social_icon',
		array(
			'title'         => __( 'Redes Sociales', 'mamihockyemisiones' ),
			'priority'      => 720,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_contact_social_panel'
		)
	);
	...
	foreach ( $social_links as $key => $value ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'section' => 'mamihockyemisiones_social_icon',
				'type'    => 'text',
			)
		);
	}
	...
	$wp_customize->add_control(
		'mamihockyemisiones_telefono',
		array(
			'label'   => __( 'Teléfono', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_contacto',
			'type'    => 'text',
		)
	);
	...
	$wp_customize->add_control(
		'mamihockyemisiones_celular',
		array(
			'label'   => __( 'Celular', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_contacto',
			'type'    => 'text',
		)
	);
	...
	$wp_customize->add_control(
		'mamihockyemisiones_mail',
		array(
			'label'   => __( 'Mail', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_contacto',
			'type'    => 'text',
		)
	);
	...
	$wp_customize->add_control(
		'mamihockyemisiones_direccion',
		array(
			'label'   => __( 'Direccion', 'mamihockyemisiones' ),
			'section' => 'mamihockyemisiones_contacto',
			'type'    => 'text',
		)
	);
	...
	//	seccion Footer
	$wp_customize->add_section(
		'mamihockyemisiones_seccion_footer',
		array(
			'title'         => __( 'Footer', 'mamihockyemisiones' ),
			'priority'      => 820,
			'capability'    => 'edit_theme_options',
			'theme_support' => '',
			'panel'         => 'mamihockyemisiones_secciones_panel'
	...
	for ( $i = 1; $i <= 3; $i ++ ) {
		...
		$wp_customize->add_control(
			...
			array(
				'label'   => __( 'Título', 'mamihockyemisiones' ),
				'section' => 'mamihockyemisiones_seccion_footer',
				'type'    => 'text',
			)
		);
